...
..  module:: analytics.settings
    :synopsis: analytics settings module
...
SECRET_KEY = 'j)@+632q-aa5(+t29#yc#1)f(3it6fu*%+ugqz=&ii*-pxs4tx'
...
from analytics.log import *  # @UnusedWildImport

USE_SNAPSHOT = False  # @TODO require future change
